...
// adapted with thanks from https://github.com/cargowire/Mono.MKNumberBadgeView
...
namespace KinskyTouch
{
    ...
    public class BadgeView : UIControl
    {
        ...
        public CGPoint AdjustOffset { get; set; }
        ...
        public override void Draw(CGRect rect)
        {
            ...
            using (CGPath badgePath = this.NewBadgePathForTextSize(numberSize))
            {
                ...
                if (this.Shadow)
                {
                    ...
                    CGSize blurSize = this.ShadowOffset;
                ...
                if (this.Shine)
                {
                    ...
                    using (CGColorSpace colorSpace = CGColorSpace.CreateDeviceRGB())
                    {
                        ...
                        using (CGGradient gradient = new CGGradient(colorSpace, shinyColorGradient, shinyLocationGradient))
                        {
                            ...
                            nfloat shineStartY = badgeRect.Height * 0.25f;
                            nfloat shineStopY = shineStartY + (badgeRect.Height * 0.4f);
                            ...
                            curContext.DrawLinearGradient(
                                gradient,
                                new CGPoint(badgeRect.Size.Width / 2.0f, 0.0f),
                                new CGPoint(badgeRect.Size.Width / 2.0f, shineStopY),
        ...
        private void InitState()
        {
            ...
            this.ShadowOffset = new CGSize(0, 3);
            ...
            this.AdjustOffset = new CGPoint(0, 0);
            this.TextFormat = "d";
        ...
        {
            nfloat arcRadius = (float)Math.Ceiling((size.Height + this.Pad) / 2.0f);
